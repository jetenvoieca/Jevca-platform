...
export default async function AccountsPage() {
  ...
  return (
    <AppShell
      ...
      navItems={[
        { label: "Sites", href: "/" },
        { label: "Alerts", href: "/alerts", badge: openAlerts.length },
        { label: "Accounts", href: "/accounts", active: true },
      ]}
      content={
        <div className="mx-auto max-w-3xl px-6 py-6">
          <h1 className="mb-1 text-2xl font-semibold text-neutral-900">Accounts</h1>
          <p className="mb-6 text-sm text-neutral-500">
            Subscription revenue by month — Stripe and manually-entered payments together.
            Totals are kept separate per currency rather than combined, since converting between
            them isn&apos;t something to do silently.
          </p>
