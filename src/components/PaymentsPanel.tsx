...
export default function PaymentsPanel({
  ...
  return (
    <div className="space-y-6">
      {/* ---------- Sale Terms — always visible, always editable, no buyer info ---------- */}
      <div>
        <h4 className="mb-1 text-sm font-medium text-neutral-700">Sale terms</h4>
        <p className="mb-3 text-xs text-neutral-400">
          What this artwork sells for — nothing here is tied to any particular buyer.
        </p>
      ...
      {/* ---------- Active purchase, or a way to start one ---------- */}
      ...
      {!terms && (
        <p className="text-sm text-neutral-400">Set sale terms above before starting a sale.</p>
      )}
      ...
      {/* ---------- History — kept simple, not deleted ---------- */}
      {history.length > 0 && (
        <div>
